...
export const ROUND3_CONSTANTS = (() => {
    ...
    const ROUND2_BN3_HIGH_BUDGET_PRODUCT_INVEST_MIN_POSTDONE = 1e9;
    const ROUND2_BN3_HIGH_BUDGET_PRODUCT_INVEST_MIN_LATE = 2.5e9;
    const PRIVATE_STAGE_MIN_UPGRADE_DELTA = Object.freeze({
        [PRIVATE_STAGE_POST_R3]: Object.freeze({ 'Smart Factories': 4, 'Smart Storage': 4, 'ABC SalesBots': 3, 'Wilson Analytics': 1 }),
        [PRIVATE_STAGE_PRE_IPO]: Object.freeze({ 'Smart Factories': 3, 'Smart Storage': 3, 'ABC SalesBots': 3, 'Wilson Analytics': 1 }),
    });
    const PRIVATE_STAGE_SPIKE_RECOVERY_SECS = 120;
    const PRIVATE_STAGE_SPIKE_DEBT_MAX = 200e9;
    const PRIVATE_STAGE_POST_R3_OVERFLOW_STRETCH_FUNDS = 750e9;
    ...
    return {
        ...
        ROUND2_BN3_HIGH_BUDGET_PRODUCT_INVEST_MIN_POSTDONE,
        ROUND2_BN3_HIGH_BUDGET_PRODUCT_INVEST_MIN_LATE,
        PRIVATE_STAGE_MIN_UPGRADE_DELTA,
