...
const ROUND1_AGRI_PRODUCT_MAT_SIZES = Object.freeze({
  ...
  const DEBUG_ASSET_MATS = ['Water', 'Chemicals', 'Food', 'Plants', 'Real Estate', 'Hardware', 'Robots', 'AI Cores'];
    ...
    if (phase <= 3) {
        ...
        log(
            ns,
            `INFO: Phase 3 - BN3 high-budget route enabled; locking the phase-3 budget from ${formatMoney(bn3HighBudgetRound2StartFunds)} and launching Chemical + Tobacco together before the round-2 wait.`,
            true,
            'info',
        );
